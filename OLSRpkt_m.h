...
class OLSR_pkt : public ::cPacket
{
  ...
  public:
    ...
    virtual void setReduceFuncionality(bool reduceFuncionality_var);
    virtual short pkt_seq_num() const;
    virtual void setPkt_seq_num(short pkt_seq_num_var);
    virtual long sn() const;
    virtual void setSn(long sn_var);
    ...
    virtual void setMsg(unsigned int k, const OLSR_msg& msg_var);
};
 ...
 * </pre>
 */
class OLSR_pkt_coded : public ::cPacket
{
  protected:
    bool reduceFuncionality_var;
    short pkt_seq_num_var;
    ...
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const OLSR_pkt_coded&);

  public:
    OLSR_pkt_coded(const char *name=NULL, int kind=0);
    OLSR_pkt_coded(const OLSR_pkt_coded& other);
    virtual ~OLSR_pkt_coded();
    OLSR_pkt_coded& operator=(const OLSR_pkt_coded& other);
    virtual OLSR_pkt_coded *dup() const {return new OLSR_pkt_coded(*this);}
    virtual void parsimPack(cCommBuffer *b);
    virtual void parsimUnpack(cCommBuffer *b);
...
inline void doPacking(cCommBuffer *b, OLSR_pkt_coded& obj) {obj.parsimPack(b);}
inline void doUnpacking(cCommBuffer *b, OLSR_pkt_coded& obj) {obj.parsimUnpack(b);}
