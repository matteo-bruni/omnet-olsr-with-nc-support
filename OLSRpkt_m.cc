//
// Generated file, do not edit! Created by opp_msgc 4.1 from networklayer/manetrouting/olsr/OLSRpkt.msg.
//
...
OLSR_pkt::OLSR_pkt(const OLSR_pkt& other) : cPacket()
{
...
void OLSR_pkt::setReduceFuncionality(bool reduceFuncionality_var)
{
    this->reduceFuncionality_var = reduceFuncionality_var;
}
...
void OLSR_pkt::setPkt_seq_num(short pkt_seq_num_var)
{
    this->pkt_seq_num_var = pkt_seq_num_var;
}
...
void OLSR_pkt::setSn(long sn_var)
{
    this->sn_var = sn_var;
}
...
void OLSR_pkt::setSend_time(double send_time_var)
{
...
void OLSR_pkt::setMsg(unsigned int k, const OLSR_msg& msg_var)
{
    if (k>=msg_arraysize) throw cRuntimeError("Array of size %d indexed by %d", msg_arraysize, k);
    this->msg_var[k]=msg_var;
}
...
Register_Class(OLSR_pkt_coded);

OLSR_pkt_coded::OLSR_pkt_coded(const char *name, int kind) : cPacket(name,kind)
{
    this->reduceFuncionality_var = false;
    this->pkt_seq_num_var = 0;
    this->sn_var = 0;
...
OLSR_pkt_coded::OLSR_pkt_coded(const OLSR_pkt_coded& other) : cPacket()
{
    setName(other.getName());
    operator=(other);
}

OLSR_pkt_coded::~OLSR_pkt_coded()
{
}

OLSR_pkt_coded& OLSR_pkt_coded::operator=(const OLSR_pkt_coded& other)
{
    if (this==&other) return *this;
    cPacket::operator=(other);
    this->reduceFuncionality_var = other.reduceFuncionality_var;
...
void OLSR_pkt_coded::parsimPack(cCommBuffer *b)
{
    cPacket::parsimPack(b);
    doPacking(b,this->reduceFuncionality_var);
    doPacking(b,this->pkt_seq_num_var);
...
void OLSR_pkt_coded::parsimUnpack(cCommBuffer *b)
{
    cPacket::parsimUnpack(b);
    doUnpacking(b,this->reduceFuncionality_var);
    doUnpacking(b,this->pkt_seq_num_var);
...
bool OLSR_pkt_coded::reduceFuncionality() const
{
    return reduceFuncionality_var;
}

void OLSR_pkt_coded::setReduceFuncionality(bool reduceFuncionality_var)
{
    this->reduceFuncionality_var = reduceFuncionality_var;
}

short OLSR_pkt_coded::pkt_seq_num() const
{
    return pkt_seq_num_var;
}

void OLSR_pkt_coded::setPkt_seq_num(short pkt_seq_num_var)
{
    this->pkt_seq_num_var = pkt_seq_num_var;
}

long OLSR_pkt_coded::sn() const
{
    return sn_var;
}

void OLSR_pkt_coded::setSn(long sn_var)
{
    this->sn_var = sn_var;
}

double OLSR_pkt_coded::send_time() const
{
    return send_time_var;
}

void OLSR_pkt_coded::setSend_time(double send_time_var)
{
    this->send_time_var = send_time_var;
}

class OLSR_pkt_codedDescriptor : public cClassDescriptor
{
  public:
    OLSR_pkt_codedDescriptor();
    virtual ~OLSR_pkt_codedDescriptor();
...
Register_ClassDescriptor(OLSR_pkt_codedDescriptor);

OLSR_pkt_codedDescriptor::OLSR_pkt_codedDescriptor() : cClassDescriptor("OLSR_pkt_coded", "cPacket")
{
}

OLSR_pkt_codedDescriptor::~OLSR_pkt_codedDescriptor()
{
}

bool OLSR_pkt_codedDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<OLSR_pkt_coded *>(obj)!=NULL;
}

const char *OLSR_pkt_codedDescriptor::getProperty(const char *propertyname) const
{
    if (!strcmp(propertyname,"omitGetVerb")) return "true";
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? basedesc->getProperty(propertyname) : NULL;
...
int OLSR_pkt_codedDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 4+basedesc->getFieldCount(object) : 4;
}

unsigned int OLSR_pkt_codedDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *OLSR_pkt_codedDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int OLSR_pkt_codedDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    int base = basedesc ? basedesc->getFieldCount(object) : 0;
    if (fieldName[0]=='r' && strcmp(fieldName, "reduceFuncionality")==0) return base+0;
...
const char *OLSR_pkt_codedDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *OLSR_pkt_codedDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int OLSR_pkt_codedDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    OLSR_pkt_coded *pp = (OLSR_pkt_coded *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string OLSR_pkt_codedDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool OLSR_pkt_codedDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *OLSR_pkt_codedDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *OLSR_pkt_codedDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
